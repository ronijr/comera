<div class="layout-content-body">
		<div class="title-bar">
			...
			<h1 class="title-bar-title">
				<span class="d-ib">Tambah Data Jabatan</span>
			</h1>
		</div>
          ...
          <div class="card-body">
            <div class="demo-form-wrapper">
              ...
              <?php
                ...
                echo form_open('jabatan/docreate', $attributes);
              ?>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="form-control-1">Nama Jabatan</label>
