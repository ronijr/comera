...
<div class="layout-content-body">
		<div class="title-bar">
			...
			<h1 class="title-bar-title">
				<span class="d-ib">Tambah Lemburan</span>
			</h1>
		</div>
          ...
          <div class="card-body">
            <div class="demo-form-wrapper">
              ...
              <?php
                ...
                echo form_open('lemburan/docreate', $attributes);
              ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2" style="margin-left:-15px;">
                        <button type="button" class="btn btn-info btn-labeled btn-find" key="lemburan"><span class="btn-label"><span class="icon icon-search icon-lg icon-fw"></span></span>Cari</button>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6  <?php if(form_error('jam_mulai') != ""): ?> has-error has-feedback <?php endif; ?>" >
                        <input id="form-control-1" class="form-control" type="time" value="<?php echo (set_value('jam_mulai') != "") ? set_value('jam_mulai') : date('H:i'); ?>" name="jam_mulai">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6  <?php if(form_error('jam_akhir') != ""): ?> has-error has-feedback <?php endif; ?>" >
                        <input id="form-control-1" class="form-control" type="time" value="<?php echo (set_value('jam_akhir') != "") ? set_value('jam_akhir') : date('H:i'); ?>" name="jam_akhir">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea id="form-control-8" class="form-control" rows="3" name="deskripsi"><?php echo set_value('deskripsi'); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
