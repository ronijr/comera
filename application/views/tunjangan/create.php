<div class="layout-content-body">
		<div class="title-bar">
			...
			<h1 class="title-bar-title">
				<span class="d-ib">Tambah Data Tunjangan</span>
			</h1>
		</div>
          ...
          <div class="card-body">
            <div class="demo-form-wrapper">
              ...
              <?php
                ...
                echo form_open('tunjangan/docreate', $attributes);
              ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6  <?php if(form_error('name') != ""): ?> has-error has-feedback <?php endif; ?>" >
                        <input id="form-control-1" class="form-control" type="text" value="<?php echo set_value('jumlah'); ?>" name="jumlah">
                    ...
                    <div class="col-sm-6 <?php if(form_error('level') != ""): ?> has-error has-feedback <?php endif; ?>">
                      <select id="form-control-6" class="form-control" name="level">
                        ...
                        <?php
                            ...
                            {
                              $selected = (set_value('level') == $key) ? 'selected' : '';
