<div class="layout-content-body">
		<div class="title-bar">
			<div class="title-bar-actions">
					<a href="<?php echo base_url('tunjangan'); ?>" class="btn btn-default">Kembali</a>
  		</div>
          ...
          <div class="card-body">
            <div class="demo-form-wrapper">
              ...
              <?php
                ...
                echo form_open('tunjangan/doupdate/'.$tunjangan[0]->tj_id.'', $attributes);
              ?>

               
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="form-control-1">Kode Tunjangan</label>
                    <div class="col-sm-3 <?php if(form_error('code') != ""): ?> has-error has-feedback <?php endif; ?>">
                        <input id="form-control-1" class="form-control" type="text" name="code" value="<?php if(!empty(set_value('code'))): ?><?php echo set_value('code'); ?><?php else: ?><?php echo $tunjangan[0]->tj_code; ?><?php endif; ?>" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6  <?php if(form_error('name') != ""): ?> has-error has-feedback <?php endif; ?>" >
                        <input id="form-control-1" class="form-control" type="text" value="<?php if(!empty(set_value('name'))): ?><?php echo set_value('name'); ?><?php else: ?><?php echo $tunjangan[0]->tj_nama; ?><?php endif; ?>" name="name">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6  <?php if(form_error('name') != ""): ?> has-error has-feedback <?php endif; ?>" >
                        <input id="form-control-1" class="form-control" type="text" value="<?php if(!empty(set_value('jumlah'))): ?><?php echo set_value('jumlah'); ?><?php else: ?><?php echo $tunjangan[0]->tj_nilai; ?><?php endif; ?>" name="jumlah">
                    ...
                    <div class="col-sm-6 <?php if(form_error('level') != ""): ?> has-error has-feedback <?php endif; ?>">
                      <select id="form-control-6" class="form-control" name="level">
                        ...
                        <?php
                            ...
                            {
                              $val = (set_value('level') == '') ? $tunjangan[0]->tj_level : set_value('level');
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <textarea id="form-control-8" class="form-control" rows="3" name="deskripsi"><?php if(!empty(set_value('deskripsi'))): ?><?php echo set_value('deskripsi'); ?><?php else: ?><?php echo $tunjangan[0]->tj_keterangan; ?><?php endif; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
