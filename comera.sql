...
--
-- Host: localhost
-- Generation Time: Jul 25, 2021 at 11:43 AM
...
(2, 'PJ210725001', 'CM210718001', 'Roni Jakarianto     ', '2021-07-22', 2000000, NULL, NULL, '', '2021-07-25', '2021-07-25 12:46:41', 'CR210701001', '2021-07-25 13:40:15', 'CR210701001', 0),
...
(7, 'CM210718001', 'Roni Jakarianto     ', '1', 100000, '0000-00-00 00:00:00', ''),
(8, 'CM210718001', 'Roni Jakarianto     ', '2', 500000, '0000-00-00 00:00:00', ''),
(9, 'CM210718001', 'Roni Jakarianto     ', '', 1000000, '0000-00-00 00:00:00', '');
...
--
ALTER TABLE `tbl_absensi`
  MODIFY `abs_id` int(15) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `tbl_m_dept`
--
ALTER TABLE `tbl_m_dept`
  MODIFY `dept_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_m_jabatan`
--
ALTER TABLE `tbl_m_jabatan`
  MODIFY `jbt_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tbl_m_karyawan`
--
ALTER TABLE `tbl_m_karyawan`
  MODIFY `kry_id` int(15) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_m_user`
  MODIFY `usr_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_tunjangan`
--
ALTER TABLE `tbl_tunjangan`
  MODIFY `tj_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_txn_penggajian`
--
ALTER TABLE `tbl_txn_penggajian`
  MODIFY `txp_id` int(15) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_txn_pinjaman`
--
ALTER TABLE `tbl_txn_pinjaman`
  MODIFY `txj_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `tbl_txn_potongan`
--
ALTER TABLE `tbl_txn_potongan`
  MODIFY `txg_id` int(15) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_txn_tunjangan`
--
ALTER TABLE `tbl_txn_tunjangan`
  MODIFY `txt_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
