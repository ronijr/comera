...
$dirname = preg_replace('@/+$@','',dirname($_SERVER['SCRIPT_NAME']));/*salah*/

$base_url= $PROTOCOL.$_SERVER['SERVER_NAME']; /*url base of site if you want only relative url leave empty*/

/*hapus /actsforum*/
$upload_dir = '/media/assets'; /*path from base_url to upload base dir*/

$current_path = '../../../../../../media/assets/'; /*relative path from filemanager folder to upload files folder*/
/*5 path ../ */

/*
$base_url="http://localhost"; //url base of site if you want only relative url leave empty
$upload_dir = '/topskor2/media/assets/'; // path from base_url to upload base dir
$current_path = '../../../../../../media/assets/'; // relative path from filemanager folder to upload files folder
*/
